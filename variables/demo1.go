...
func Demo1() {
	...
	kdv3 := 25 // a different definition in Go language. I've never seen this before. we can write anything we want here. The programme will define its type automatically.
	fmt.Println(kdv3)
